...
# interest_1[0] = 'Naver'
# print(interest_0)
## 얕은 복사로 인해서 interest_1과 interest_0이 동일한 주소 갖게 됨
## interest_1의 요소값을 수정하면 interest_0도 같은 값을 참조하게 됨
## 실제 두 변수가 참조하는 값이 수정된 결과로 나타남

# 결과 예측 : ['Naver','LG전자','SK Hynix']

#22
# 다음 코드의 결과값에 대해 예측하여라
# interest_0 = ['삼성전자', 'LG전자', 'SK Hynix']
# interest_1 = interest_0[:2] #깊은 복사 발생, 값을 가져와서 새로 interest_1 리스트 생성
## interest_1 = ['삼성전자', 'LG전자', 'SK Hynix'] 의미와 같다.
# interest_1[0] = 'Naver'
# print(interest_0)
## interest_1의 요소를 변경해도 interest_0번의 값은 변하지 않는다.
## 두 변수는 서로 다른 주소를 참조하게 됨

# 결과 예측 : ['삼성전자', 'LG전자', 'SK Hynix']